...
public class TestaString1 {
	...
	public static void main(String[] args) {
		String a = new String("Java ADS na veia"); //só funciona a diferença ao instanciar o objeto, sem o new funciona como timo não primitivo/objeto
		...
		//se quero comparar o conteúdo de um objeto String, é necessário usar o método equals
